...
export type RoleType = 'admin' | 'operator' | 'VIP';
...
const nickNames = ['admin', 'user1', 'user2', 'user3'];
const emails = ['admin@qq.com', 'test@qq.com', 'test2@qq.com', 'test3@qq.com'];
const phones = ['12345678910', '10923456789', '109654446789', '109223346789'];
const permissions = [[], ['VIP'], ['普通用户'], ['普通用户']];

for (let i = 0; i < 4; i += 1) {
  tableListDataSource.push({
    outUserNo: `${102047 + i}`,
    avatar: '',//https://gw.alipayobjects.com/zos/antfincdn/upvrAjAPQX/Logo_Tech%252520UI.svg
    role: i === 0 ?  'admin' : (i === 1 ? 'VIP' : 'operator'),
